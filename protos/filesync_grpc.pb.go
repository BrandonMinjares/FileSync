...
const (
	...
	FileSyncService_NotifyTrusted_FullMethodName      = "/filesyncpb.FileSyncService/NotifyTrusted"
)
...
type FileSyncServiceClient interface {
	...
	NotifyTrusted(ctx context.Context, in *NotifyTrustedRequest, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *fileSyncServiceClient) NotifyTrusted(ctx context.Context, in *NotifyTrustedRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, FileSyncService_NotifyTrusted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileSyncServiceServer interface {
	...
	NotifyTrusted(context.Context, *NotifyTrustedRequest) (*Ack, error)
...
func (UnimplementedFileSyncServiceServer) ReceiveFolder(grpc.ClientStreamingServer[FolderChunk, Ack]) error {
	return status.Error(codes.Unimplemented, "method ReceiveFolder not implemented")
}
...
func (UnimplementedFileSyncServiceServer) ReceiveUpdatedFile(context.Context, *FileUpdate) (*Ack, error) {
	return nil, status.Error(codes.Unimplemented, "method ReceiveUpdatedFile not implemented")
}
func (UnimplementedFileSyncServiceServer) NotifyTrusted(context.Context, *NotifyTrustedRequest) (*Ack, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyTrusted not implemented")
}
...
func _FileSyncService_NotifyTrusted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotifyTrustedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileSyncServiceServer).NotifyTrusted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileSyncService_NotifyTrusted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileSyncServiceServer).NotifyTrusted(ctx, req.(*NotifyTrustedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileSyncService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NotifyTrusted",
			Handler:    _FileSyncService_NotifyTrusted_Handler,
		},
	},

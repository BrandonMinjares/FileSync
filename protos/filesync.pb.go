...
type NotifyTrustedRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Device ID (base32) of the peer who accepted the connection
	RequesterId   string `protobuf:"bytes,1,opt,name=requester_id,json=requesterId,proto3" json:"requester_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *NotifyTrustedRequest) Reset() {
	*x = NotifyTrustedRequest{}
	mi := &file_protos_filesync_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifyTrustedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifyTrustedRequest) ProtoMessage() {}

func (x *NotifyTrustedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protos_filesync_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifyTrustedRequest.ProtoReflect.Descriptor instead.
func (*NotifyTrustedRequest) Descriptor() ([]byte, []int) {
	return file_protos_filesync_proto_rawDescGZIP(), []int{7}
}

func (x *NotifyTrustedRequest) GetRequesterId() string {
	if x != nil {
		return x.RequesterId
	}
	return ""
...
func (x *Empty) Reset() {
	*x = Empty{}
	mi := &file_protos_filesync_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_protos_filesync_proto_rawDescGZIP(), []int{9}
}
...
const file_protos_filesync_proto_rawDesc = "" +
	...
	"\x12ReceiveUpdatedFile\x12\x16.filesyncpb.FileUpdate\x1a\x0f.filesyncpb.Ack\x12B\n" +
	"\rNotifyTrusted\x12 .filesyncpb.NotifyTrustedRequest\x1a\x0f.filesyncpb.AckB\x1eZ\x1csynthesize/protos;filesyncpbb\x06proto3"
...
var file_protos_filesync_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protos_filesync_proto_goTypes = []any{
	...
	(*NotifyTrustedRequest)(nil),  // 7: filesyncpb.NotifyTrustedRequest
	(*FileUpdate)(nil),            // 8: filesyncpb.FileUpdate
	(*Empty)(nil),                 // 9: filesyncpb.Empty
...
var file_protos_filesync_proto_depIdxs = []int32{
	...
	10, // 1: filesyncpb.UpdateRequest.timestamp:type_name -> google.protobuf.Timestamp
	10, // 2: filesyncpb.FileUpdate.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 3: filesyncpb.FileSyncService.SendFile:input_type -> filesyncpb.FileChunk
	9,  // 4: filesyncpb.FileSyncService.ReceiveFile:input_type -> filesyncpb.Empty
	...
	8,  // 8: filesyncpb.FileSyncService.ReceiveUpdatedFile:input_type -> filesyncpb.FileUpdate
	7,  // 9: filesyncpb.FileSyncService.NotifyTrusted:input_type -> filesyncpb.NotifyTrustedRequest
	2,  // 10: filesyncpb.FileSyncService.SendFile:output_type -> filesyncpb.Ack
	0,  // 11: filesyncpb.FileSyncService.ReceiveFile:output_type -> filesyncpb.FileChunk
	4,  // 12: filesyncpb.FileSyncService.RequestConnection:output_type -> filesyncpb.ConnectionResponse
	2,  // 13: filesyncpb.FileSyncService.ReceiveFolder:output_type -> filesyncpb.Ack
	6,  // 14: filesyncpb.FileSyncService.RequestUpdate:output_type -> filesyncpb.UpdateResponse
	2,  // 15: filesyncpb.FileSyncService.ReceiveUpdatedFile:output_type -> filesyncpb.Ack
	2,  // 16: filesyncpb.FileSyncService.NotifyTrusted:output_type -> filesyncpb.Ack
